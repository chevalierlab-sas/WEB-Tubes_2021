<template>
  ...
  <div class="hero-content flex-col lg:flex-row">
    ...
    <div>
      ...
      <p class="py-6 pr-10"> a short description or comment on a movie that is displayed on movie posters (or direct to video covers, etc.) to capture the essence of the movie, and ultimately make you watch the movie. -IMDB</p>
