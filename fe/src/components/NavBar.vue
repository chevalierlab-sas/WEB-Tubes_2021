      ...
      <div class="flex-none">
          ...
          >
            <div class="card-body">
              ...
              <div class="card-actions">
                <button>
                  <router-link to="/Watchlist" class="btn btn-primary btn-block"
                    >Watchlistku
                  </router-link>
                </button>
              </div>
        ...
        <div class="modal">
          <div class="modal-box relative">
            ...
            <form>
              <div>
                <img src="../assets/logo.svg" class="rounded-full w-20 mx-48" />
                <p class="text-xl text-center font-bold">Login ke ChevaMovie</p>
              </div>
